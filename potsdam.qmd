---
title: "Politische Aktivität und Reichtumserhalt"
author: "Daria Tisch¹ & Lena Radau² <br>  <br> 11. November 2022 <br> <br> ¹Max Planck Institute for the Study of Societies <br> ²Bielefeld University"
#subtitle:  
format: 
  revealjs:
...
all_all2 =ggraph(graphi_layout) +
  geom_edge_link0( edge_width = 2/.pt, alpha = 0.7 ) +
  ...
  scale_size_manual(values= c(1,3,3,3,3,3)) +
  scale_alpha_manual(values= c(0.35,1,1,1,1,1)) +
  guides(size = "none")   +
